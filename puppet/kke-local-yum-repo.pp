...
# file with the name specified in the question e.g. news.pp
...
# Step 4: Verify that the required package e.g. samba is installed from local repo
# using 'repoquery -i samba'
# (You may have to install `yum-utils` for repoquery to work - 'sudo yum install -y yum-utils')
#
